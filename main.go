...
func main() {
	...
	// nice := get.Epicmerge()
	// fmt.Println(nice[51].Id)
	// fmt.Println(nice[51].Image)
	// fmt.Println(nice[51].Name)
	// fmt.Println(nice[51].Members)
	// fmt.Println(nice[51].CreationDate)
	// fmt.Println(nice[51].FirstAlbum)
	// fmt.Println(nice[51].Locations)
	// fmt.Println(nice[51].ConcertDates)
	// fmt.Println(nice[51].Relations)
